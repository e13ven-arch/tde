...
def main() -> None:
    ...
    ap.add_argument("--chunk_k", type=int, default=None, help="score candidate sets in chunks of this size (large-K inference)")
    args = ap.parse_args()
    rep = evaluate_run(args.run, args.data_dir, args.split, args.limit, args.batch_size,
                       controls=not args.no_controls, fit_temperature=not args.no_temperature, max_total=args.max_total, chunk_k=args.chunk_k)
