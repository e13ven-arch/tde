...
| Exp 005 数据广度 | v0.2，每集 1.5 万，1 epoch | 100% | 61.1% | 33.3% | 55.8% | 0.591 | — |
| Exp 006 候选数课程 | v0.3 | 100% | 65.3% | 30.6% | 56.3% | — | — |
...
**提交路径（2026-09-25）**：PR #38 与 issue #39 已关闭，改为 issue #88：`tde-serve`（v0.1.1）提供 `/v1/systemone` 服务，维护者用其自带 `typesafe` 适配器原样测量，无需合并任何适配器。用该路径在本机复核：231/231，130 对，与进程内适配器合计一致。
